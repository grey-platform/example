...
::源文件设置
set sourcefile[0]=actiondlg
set sourcefile[1]=main
set sourcefile[2]=mainlayer
set sourcefile[3]=workcanvas

::包文件输出目录及文件名
set EPKFILE=wfxfileview.epk
...
set MODULELIBS=%GDK_PATH%\lib\standard.asl %GDK_PATH%\lib\bigimage.asl
